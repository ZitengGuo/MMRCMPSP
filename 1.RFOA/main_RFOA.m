...
while  BP <= T_BP
    ...
    UP = ceil(FP/50);
    %% M_gb
    M_gb = GetMgb_f(I,J,K,N2,NRC,numdata3);
    %% Benchmark problems
    if BP==11
    ...
    % Multiple Runs
    for i=1:run
        [P,A,M,gbest,gb,Itr_time] = RFOA_f(I,J,K,N1,N2,Su,DM,RRC,NRC,URUC,URIC,UNRUC,...
            RD,DD,FP,UB,UP,NI,NK,N_r,N_v,MF,Pm,Pg,M_gb,BP);
        %%
        run_gb{i,:} = gb;
